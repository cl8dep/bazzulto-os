...
// Original: Marcel Sondaar / IBM public domain VGA fonts
// License: Public Domain
//
// ASCII glyphs: font8x8_basic.h (U+0020..U+007F)
// Latin-1 Supplement: font8x8_ext_latin.h (U+00A0..U+00FF)
// ---------------------------------------------------------------------------

// ASCII table: direct index by (codepoint - 0x20), 96 entries.
static const uint8_t ascii_glyphs[96][8] = {
...
// Latin-1 Supplement table: direct index by (codepoint - 0xA0), 96 entries.
static const uint8_t latin1_glyphs[96][8] = {
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},   // U+00A0 (no break space)
    { 0x18, 0x18, 0x00, 0x18, 0x18, 0x18, 0x18, 0x00},   // U+00A1 (!)
    { 0x18, 0x18, 0x7E, 0x03, 0x03, 0x7E, 0x18, 0x18},   // U+00A2 (cent)
    { 0x1C, 0x36, 0x26, 0x0F, 0x06, 0x67, 0x3F, 0x00},   // U+00A3 (pound)
    { 0x00, 0x00, 0x63, 0x3E, 0x36, 0x3E, 0x63, 0x00},   // U+00A4 (currency)
    { 0x33, 0x33, 0x1E, 0x3F, 0x0C, 0x3F, 0x0C, 0x0C},   // U+00A5 (yen)
    { 0x18, 0x18, 0x18, 0x00, 0x18, 0x18, 0x18, 0x00},   // U+00A6 (broken pipe)
    { 0x7C, 0xC6, 0x1C, 0x36, 0x36, 0x1C, 0x33, 0x1E},   // U+00A7 (section)
    { 0x33, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},   // U+00A8 (diaeresis)
    { 0x3C, 0x42, 0x99, 0x85, 0x85, 0x99, 0x42, 0x3C},   // U+00A9 (copyright)
    { 0x3C, 0x36, 0x36, 0x7C, 0x00, 0x00, 0x00, 0x00},   // U+00AA (superscript a)
    { 0x00, 0xCC, 0x66, 0x33, 0x66, 0xCC, 0x00, 0x00},   // U+00AB (<<)
    { 0x00, 0x00, 0x00, 0x3F, 0x30, 0x30, 0x00, 0x00},   // U+00AC (not)
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},   // U+00AD (soft hyphen)
    { 0x3C, 0x42, 0x9D, 0xA5, 0x9D, 0xA5, 0x42, 0x3C},   // U+00AE (registered)
    ...
    { 0x18, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},   // U+00B4 (acute)
    ...
    { 0x00, 0x36, 0x1C, 0x08, 0x1C, 0x36, 0x00, 0x00},   // U+00D7 (multiply)
...
// Euro sign (U+20AC) — hand-drawn, not in font8x8.
static const uint8_t euro_glyph[8] = {
    0x1C, 0x22, 0x78, 0x20, 0x78, 0x22, 0x1C, 0x00
};

// Replacement glyph for unknown codepoints (filled square).
static const uint8_t replacement_glyph[8] = {
    0x7E, 0x7E, 0x7E, 0x7E, 0x7E, 0x7E, 0x7E, 0x00
};

const uint8_t *font_latin_extended_lookup(uint32_t codepoint)
{
    // ASCII (U+0020..U+007F) — O(1) direct table
    if (codepoint >= 0x20 && codepoint <= 0x7F)
        return ascii_glyphs[codepoint - 0x20];

    // Latin-1 Supplement (U+00A0..U+00FF) — O(1) direct table
